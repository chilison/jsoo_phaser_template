(** Copyright 2021-2022, Roddy MacSween *)

(** SPDX-License-Identifier: MIT *)

(* Currently it is a copypaste from https://github.com/roddyyaga/ws-server
   Need to wait for https://github.com/roddyyaga/ws-server/issues/1 to be fixed
*)
